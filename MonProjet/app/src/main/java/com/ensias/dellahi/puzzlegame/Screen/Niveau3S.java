...
public class Niveau3S extends Screen {
    ...
    private NiveauSprite winmsg;
    private Returnhome rm;
    private int f=0;

    public Niveau3S(Game game, int indice) {
        super(game);
        BaseAsset.rm= game.getGraphics().newImage(R.drawable.rm,Graphics.ImageFormat.ARGB8888,game.getResources());
        BaseAsset.winmsg= game.getGraphics().newImage(R.drawable.fin,Graphics.ImageFormat.ARGB8888,game.getResources());
        ...
        BaseAsset.partN31.add(game.getGraphics().newImage(R.drawable.pic8part1, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.partN31.add(game.getGraphics().newImage(R.drawable.pic9part1, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.partN31.add(game.getGraphics().newImage(R.drawable.pic10part1, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.partN32.add(game.getGraphics().newImage(R.drawable.pic8part2, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.partN32.add(game.getGraphics().newImage(R.drawable.pic9part2, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.partN32.add(game.getGraphics().newImage(R.drawable.pic10part2, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.part33.add(game.getGraphics().newImage(R.drawable.pic8part3, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.part33.add(game.getGraphics().newImage(R.drawable.pic9part3, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.part33.add(game.getGraphics().newImage(R.drawable.pic10part3, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.part34.add(game.getGraphics().newImage(R.drawable.pic8part4, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.part34.add(game.getGraphics().newImage(R.drawable.pic9part4, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.part34.add(game.getGraphics().newImage(R.drawable.pic10part4, Graphics.ImageFormat.ARGB8888,game.getResources()));
        BaseAsset.rideau=game.getGraphics().newImage(R.drawable.rideau,Graphics.ImageFormat.ARGB8888,game.getResources());
        BaseAsset.N3T=0;
        ...
        part1 = new NiveauSprite(game ,BaseAsset.partN31.get(indice),(int)Math.round(0.3240*w_unit),(int)Math.round(0.1532*h_unit),(int)Math.round(0.1254*h_unit),(int)Math.round(0.2083*w_unit));
        part2 = new NiveauSprite(game , BaseAsset.partN32.get(indice),(int)Math.round(0.1111*w_unit),(int)Math.round(0.1532*h_unit),(int)Math.round(0.1254*h_unit),(int)Math.round(0.2083*w_unit));
        part3 = new NiveauSprite(game ,BaseAsset.part33.get(indice),(int)Math.round(0.3240*w_unit),(int)Math.round(0.2814*h_unit),(int)Math.round(0.1254*h_unit),(int)Math.round(0.2083*w_unit));
        part4 = new NiveauSprite(game , BaseAsset.part34.get(indice),(int)Math.round(0.1111*w_unit),(int)Math.round(0.2814*h_unit),(int)Math.round(0.1254*h_unit),(int)Math.round(0.2083*w_unit));
        ...
        pic = new NiveauSprite(game , BaseAsset.pict.get(indice+7),(int)Math.round(0.1203*w_unit),(int)Math.round(0.5323*h_unit),(int)Math.round(0.2508*h_unit),(int)Math.round(0.4166*w_unit));
        ...
        winmsg= new NiveauSprite(game , BaseAsset.winmsg,0,0,h_unit,w_unit);
        ...
        rm= new Returnhome(game , BaseAsset.rm,(int)Math.round(0.5555*w_unit),(int)Math.round(0.8*h_unit),(int)Math.round(0.1393*h_unit),(int)Math.round(0.3703*w_unit));
        addSprite(bg);
        ...
        MenuScreen.gameStat.setLevel_id("3");
    }
    ...
    public void handleTouchDown (int x, int y, int pointer){
        ...
        if (s.getClass()==NiveauSprite.class){
            ...
            if(valider.equals(n)){
                ...
                if (BaseAsset.i ==2){ this.addSprite(winmsg); this.addSprite(rm);}
            }
            if(again.equals(n)){
                if (f==1 & BaseAsset.i <2) BaseAsset.i++;
                Niveau3S ss= new Niveau3S(game, BaseAsset.i);
                game.setScreen(ss);
